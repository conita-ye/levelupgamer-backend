...
public class ProductDataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Categoria polerones = obtenerOCrearCategoria("POLERONES_GAMERS", "Polerones Gamers Personalizados",
                "Polerones gamer personalizables con diseños exclusivos");
        ...
        Producto jm001 = Producto.builder()
                ...
                .puntosLevelUp(200)
                .fabricante("Klaus Teuber / Asmodee")
                .distribuidor("Asmodee Chile")
        ...
        Producto jm002 = Producto.builder()
                ...
                .categoria(juegosMesa)
                .puntosLevelUp(200)
                .fabricante("Hans im Glück / Asmodee")
                .distribuidor("Asmodee Chile")
        ...
        Producto ac001 = Producto.builder()
                ...
                .distribuidor("Microsoft Store Chile")
        ...
        Producto ac002 = Producto.builder()
            ...
            .categoria(accesorios)
            .puntosLevelUp(400)
            .fabricante("HyperX (HP)")
            .distribuidor("HP Chile / Falabella / Ripley")
        ...
        Producto co001 = Producto.builder()
                ...
                .distribuidor("Sony Store Chile / Falabella / Ripley")
        ...
        Producto cg001 = Producto.builder()
                ...
                .puntosLevelUp(1000)
                .fabricante("ASUS")
                .distribuidor("ASUS Chile / Falabella / Ripley")
        ...
        Producto sg001 = Producto.builder()
                ...
                .distribuidor("Secretlab Store Chile")
        ...
        Producto ms001 = Producto.builder()
                ...
                .puntosLevelUp(200)
                .fabricante("Logitech")
                .distribuidor("Logitech Chile / Falabella / Ripley")
        ...
        Producto mp001 = Producto.builder()
                ...
                .puntosLevelUp(100)
                .fabricante("Razer")
                .distribuidor("Razer Store Chile / Falabella")
        ...
        Producto pp001 = Producto.builder()
                ...
                .categoria(poleras)
                .puntosLevelUp(100)
                .fabricante("LevelUp Store")
                .distribuidor("LevelUp Store")
        ...
        Producto kb001 = Producto.builder()
                ...
                .puntosLevelUp(400)
                .fabricante("Razer / Logitech / Corsair")
                .distribuidor("Razer Store / Logitech Chile / Falabella")
        ...
        Producto hs002 = Producto.builder()
                ...
                .categoria(audio)
                .puntosLevelUp(300)
                .fabricante("HyperX / Razer / SteelSeries")
                .distribuidor("HP Chile / Razer Store / Falabella")
        ...
        Producto ch003 = Producto.builder()
                ...
                .categoria(sillas)
                .puntosLevelUp(500)
                .fabricante("DXRacer / AKRacing / Secretlab")
                .distribuidor("Falabella / Ripley / Paris")
        ...
        Producto mon004 = Producto.builder()
                ...
                .categoria(monitores)
                .puntosLevelUp(600)
                .fabricante("LG / ASUS / Acer")
                .distribuidor("LG Chile / ASUS Chile / Falabella")
        ...
        Producto pc006 = Producto.builder()
                ...
                .categoria(computadores)
                .puntosLevelUp(1000)
                .fabricante("NVIDIA / ASUS / MSI")
                .distribuidor("ASUS Chile / MSI Chile / Falabella")
        ...
        Producto kit008 = Producto.builder()
                ...
                .categoria(audio)
                .puntosLevelUp(700)
                .fabricante("Elgato / Blue Yeti / Logitech")
                .distribuidor("Elgato Store / Falabella / Ripley")
        ...
        // PG001 - Polerón Gamer Personalizado 'Level-Up'
        Producto pg001 = Producto.builder()
                .codigo("PG001")
                .nombre("Polerón Gamer Personalizado 'Level-Up'")
                .descripcion("Polerón cómodo y cálido con capucha, ideal para sesiones de gaming. Personalizable con tu gamer tag o diseño favorito.")
                .precio(new BigDecimal("24990"))
                .stock(18)
                .stockCritico(6)
                .categoria(polerones)
                ...
                .fabricante("LevelUp Store")
                .distribuidor("LevelUp Store")
                .imagenes(Collections.singletonList(buildProductImage("PG001", "https://picsum.photos/seed/levelup-hoodie/800/800")))
                .activo(true)
                .vendedor(levelUpVendor)
                .build();
        productoRepository.save(pg001);
    }
